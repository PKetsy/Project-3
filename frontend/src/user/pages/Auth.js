...
const Auth = () => {
      ...
      setFormData(
        {
          ...formState.inputs,
          name: undefined,
          //   copy all previous fields, and make name and image undefined for user to enter themselves
          image: undefined,
        },
  ...
  const authSubmitHandler = async (event) => {
    ...
    if (isLoginMode) {
      try {
        //don't just log in, but instead send an HTTP request.
      ...
      try {
        ...
        //formData can accept text data AND binary data...like files
